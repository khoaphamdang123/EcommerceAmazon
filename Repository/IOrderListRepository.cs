...
public interface IOrderRepository
{
  ...
  public Task<int> createOrder(UserOrderInfo user,List<CartModel> cart,Payment payment,string country,string state,string city,string zip_code,string note);
