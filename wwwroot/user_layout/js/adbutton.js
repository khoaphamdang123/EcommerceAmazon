...
var freeShipMin =1000000;
var totalCartMin =0;

var percentFreeShip = "";
var imgCartNo = "//theme.hstatic.net/1000382550/1001195580/14/cart_banner_image.jpg?v=273";
...
HRT.All = {
	...
	clone_item: function(product, i, xHasyPrice){
		...
		if ( product.image == null ) {
			item_product.find('img').attr('src','//theme.hstatic.net/1000382550/1001195580/14/no_image.jpg?v=273').attr('alt', product.url);
		} else {
...
HRT.Index = {
	...
	sliderBannerTop: function(){
		if ($("#homepage-slider").length > 0){
			...
			var checkloop = false;
			if($('#homepage-slider .slider-item').length > 1 && $('#homepage-slider .slider-item.item-video').length == 0  ){ 
				checkloop = true;
			}
			...
			mainSlider.find('.owl-next').attr('aria-label', 'next slide');
			mainSlider.find('.owl-prev').attr('aria-label', 'prev slide');
		}
	},
